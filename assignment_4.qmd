...
#| echo = FALSE
ggplot(data = economist_data) +
  geom_point(mapping = aes(x = CPI, y = HDI, color = Region, size = -HDI))
```
...
ggplot(data = economist_data, aes(x = HDI)) +
  geom_density(mapping = aes(color = Region), alpha = .5)
...
#| echo = FALSE
ggplot(data = economist_data, aes(x = HDI)) +
  geom_histogram(mapping = aes(color = Region)) +
  facet_wrap(~ Region)
```
...
```{r}
#| echo = FALSE
ggplot(data = economist_data, aes(y = HDI)) +
  geom_boxplot(mapping = aes(color = Region), alpha = .5)
```
